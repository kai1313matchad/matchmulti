                ...
                <div class="col-sm-12 col-xs-12">
                    <table class="table table-bordered tb-body">
                        <thead>
                            ...
                            <th class="col-sm-5 col-xs-5 td-center">Description</th>
                            <th class="col-sm-2 col-xs-2 td-center">PPN</th>
                            <th class="col-sm-2 col-xs-2 td-center">PPH</th>
                ...
                {   
                    for (var i = 0; i < data.length; i++)
                    {
                        var $tr = $('<tr>').append(
                            ...
                            $('<td class="text-right font-txt">'+money_conv(data[i]["CSTDT_PPNAMOUNT"])+'</td>'),
                            $('<td class="text-right font-txt">'+money_conv(data[i]["CSTDT_PPHAMOUNT"])+'</td>'),
