<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Finance - Laporan Usia Hutang</h1>
                    </div>
                </div>
                <div class="row">
    ...
    <script>
        ...
        function show_rptaccpay()
        {
            ...
            if(n != null)
            {
                ...
                var seg5 = n;
                if (n==1) {
                    window.open ( "<?php echo site_url('administrator/Finance/print_rptagepay/')?>"+seg1+'/'+seg2+'/'+seg3+'/'+seg4+'/'+seg5,'_blank');
                }else {
                    window.open ( "<?php echo site_url('administrator/Finance/print_rptagepaysummary/')?>"+seg1+'/'+seg2+'/'+seg3+'/'+seg4+'/'+seg5,'_blank');
                }
            }
            else
            {
