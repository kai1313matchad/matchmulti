<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Finance - Laporan Usia Piutang</h1>
                    </div>
                </div>
                <div class="row">
                        ...
                        <table id="dtb_rptaccrcv" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Kode Klien</th>
                                    <th class="text-center">Nama Klien</th>
                                    <th class="col-sm-2 text-center">Nominal</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <script>
        ...
        function show_rptaccrcv()
        {
            ...
            if(n != null)
            {
                ...
                var seg5 = n;
                if (n==1) {
                    window.open ( "<?php echo site_url('administrator/Finance/print_rptagercv/')?>"+seg1+'/'+seg2+'/'+seg3+'/'+seg4+'/'+seg5,'_blank');
                }else {
                    window.open ( "<?php echo site_url('administrator/Finance/print_rptagercvsummary/')?>"+seg1+'/'+seg2+'/'+seg3+'/'+seg4+'/'+seg5,'_blank');
                }
            }
            else
            {
    ...
    <script>
        ...
        {            
            table = $('#dtb_rptaccrcv').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo site_url('administrator/Showdata/showrpt_agercv')?>",
                    "type": "POST",
                    "data": function(data){
