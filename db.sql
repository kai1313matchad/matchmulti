...
-- Dumping data for table mtpdmulti.chart_of_account: ~1,076 rows (approximately)
...
-- Dumping data for table mtpdmulti.group_user: ~189 rows (approximately)
...
-- Dumping data for table mtpdmulti.his_cashin: ~8 rows (approximately)
...
-- Dumping data for table mtpdmulti.his_giroin: ~8 rows (approximately)
...
-- Dumping data for table mtpdmulti.other_settings: ~4 rows (approximately)
...
-- Dumping data for table mtpdmulti.trx_cash_in: ~2 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `trx_giro_in` (
  ...
  KEY `FK_trx_giro_in_chart_of_account` (`COA_ID`),
  ...
  CONSTRAINT `FK_trx_giro_in_chart_of_account` FOREIGN KEY (`COA_ID`) REFERENCES `chart_of_account` (`COA_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `trx_giro_out` (
  ...
  KEY `FK_trx_giro_out_chart_of_account` (`COA_ID`),
  ...
  CONSTRAINT `FK_trx_giro_out_chart_of_account` FOREIGN KEY (`COA_ID`) REFERENCES `chart_of_account` (`COA_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
