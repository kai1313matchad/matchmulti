...
-- Dumping data for table mtpdmulti.his_prc: ~34 rows (approximately)
...
-- Dumping data for table mtpdmulti.po_details: ~8 rows (approximately)
...
-- Dumping data for table mtpdmulti.trx_approvalbill: ~8 rows (approximately)
